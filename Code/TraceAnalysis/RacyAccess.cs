namespace TraceAnalysis
{
    ...
    public class RacyAccess
    {
        ...
        public RacyAccess(MemoryAccess read, ReadType readType, MemoryAccess write, WriteType writeType)
        {
            ...
            this.AccessGapMs = (int)Math.Ceiling(1.0 * Math.Max(Constants.ExternalInterferenceLambda, Math.Abs(read.Timestamp - write.Timestamp)) / TimeSpan.TicksPerMillisecond);
        }
