...
namespace NSubstitute.Acceptance.Specs
{
    ...
    {
        [Test]
        public void Issue205()
        {
            var task1 = System.Threading.Tasks.Task.Run(() => { CreateDelegateMock(times: 50); });
            var task2 = System.Threading.Tasks.Task.Run(() => { CreateDelegateMock(times: 50); });
            CreateDelegateMock(times: 50);

            System.Threading.Tasks.Task.WaitAll(task1, task2);
        }

        private void CreateDelegateMock(int times)
        {
